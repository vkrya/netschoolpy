"""Утилита формирования чистого models.py без дублирования полей."""

clean_models_code = '''from __future__ import annotations
...
with open('netschoolpy/models.py', 'w', encoding='utf-8') as f:
    f.write(clean_models_code)

print('Rewrote netschoolpy/models.py cleanly!')
